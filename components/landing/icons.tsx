...
export function ProjekinBrandLogo({ className = "" }: IconProps) {
  return (
    <div className={`flex items-center gap-2.5 group ${className}`}>
      <ProjekinTechIcon className="h-8 w-8 text-purple-400 transition duration-300 group-hover:text-purple-300" />
...
export function AcademicIcon({ className = "h-4 w-4" }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden="true">
